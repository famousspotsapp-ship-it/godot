...
See [`ARCHITECTURE.md`](ARCHITECTURE.md) for how the project is put together
(runtime-built `SpriteFrames`, the procedurally generated level, the
`GameManager` autoload, and the physics layer conventions).
